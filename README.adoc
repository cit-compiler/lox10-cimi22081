...
[source,console]
----
$ java com.craftinginterpreters.lox.Lox Parser.java
Exception in thread "main" java.nio.file.NoSuchFileException: Parser.java
        ...
        at com.craftinginterpreters.lox.Lox.runFile(Lox.java:24)
        at com.craftinginterpreters.lox.Lox.main(Lox.java:18)
----
